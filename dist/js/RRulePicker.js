...
Component.options.__file = "/Users/louck/Development/Code/vue-rrulepicker/src/RRulePicker.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] RRulePicker.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1a6b30f9", Component.options)
  } else {
    hotAPI.reload("data-v-1a6b30f9", Component.options)
  }
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return DUTCH; });
/* unused harmony export dutchStrings */
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    'nl': {
        ...
        'months': [{ 'key': 1, 'value': 'Jan', 'value_full': 'januari' }, { 'key': 2, 'value': 'Feb', 'value_full': 'feburari' }, { 'key': 3, 'value': 'Mar', 'value_full': 'maart' }, { 'key': 4, 'value': 'Apr', 'value_full': 'april' }, { 'key': 5, 'value': 'May', 'value_full': 'mei' }, { 'key': 6, 'value': 'Jun', 'value_full': 'juni' }, { 'key': 7, 'value': 'Jul', 'value_full': 'juli' }, { 'key': 8, 'value': 'Aug', 'value_full': 'augustus' }, { 'key': 9, 'value': 'Sep', 'value_full': 'septembet' }, { 'key': 10, 'value': 'Oct', 'value_full': 'oktober' }, { 'key': 11, 'value': 'Nov', 'value_full': 'november' }, { 'key': 12, 'value': 'Dec', 'value_full': 'december' }],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__compare_es6__ = __webpack_require__(143);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__RRulePickerCalendarPanel_vue__ = __webpack_require__(136);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__RRulePickerCalendarPanel_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__RRulePickerCalendarPanel_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__languages_rrulepicker_js__ = __webpack_require__(128);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__languages_rrule_js__ = __webpack_require__(127);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    //COMPONENTS
    , components: {
        RRulePickerCalendarPanel: __WEBPACK_IMPORTED_MODULE_1__RRulePickerCalendarPanel_vue___default.a
        ...
        return {
            ...
            RRule: __webpack_require__(135).RRule
        };
    },
    ...
    computed: {
        translation: function translation() {
            return __WEBPACK_IMPORTED_MODULE_2__languages_rrulepicker_js__["a" /* default */][this.lang] || __WEBPACK_IMPORTED_MODULE_2__languages_rrulepicker_js__["a" /* default */]['en'];
        },
        innerPlaceholder: function innerPlaceholder() {
            return this.placeholder || this.translation.placeholder;
        },
        text: function text() {
            var that = this;
    ...
    , methods: {
        getWidth: function getWidth() {
            ...
            return __WEBPACK_IMPORTED_MODULE_0__compare_es6__["a" /* is_numeric */](that.width) ? that.width + 'px' : that.width;
        },
            ...
            if (that.rrule.frequency) {
                ...
                switch (that.rrule.frequency) {
                    ...
                    case 'WEEKLY':
                        ...
                        if (__WEBPACK_IMPORTED_MODULE_0__compare_es6__["b" /* is_string */](that.rrule.byday)) {
                    ...
                    case 'MONTHLY':
                        ...
                        switch (that.rrule.monthly_type) {
                            case 'number':
                                ...
                                if (__WEBPACK_IMPORTED_MODULE_0__compare_es6__["b" /* is_string */](that.rrule.bymonthday)) {
                ...
                // Create a rule:
                var rule = new that.RRule({
                    freq: frequency,
                    interval: interval,
                    byweekday: byday,
                    bymonthday: bymonthday,
                    bymonth: bymonth,
                    bysetpos: __WEBPACK_IMPORTED_MODULE_0__compare_es6__["a" /* is_numeric */](that.rrule.bysetpos) ? parseInt(that.rrule.bysetpos) : 1,
        ...
        getText: function getText() {
            ...
            if (that.value) {
                ...
                if (rule) {
                    return rule.toText(__WEBPACK_IMPORTED_MODULE_3__languages_rrule_js__["a" /* gettext */], __WEBPACK_IMPORTED_MODULE_3__languages_rrule_js__["b" /* DUTCH */]);
                }
            }
        },
        ...
        displayPopup: function displayPopup() {
            ...
            var PopupRect = this.$refs.calendar.getBoundingClientRect();
            this.position = {};
    ...
    selectDate: function selectDate(cell) {
      ...
      if (this.$parent.type === 'datetime') {
        ...
        this.$nextTick(function () {
          Array.prototype.forEach.call(_this.$el.querySelectorAll('.mx-time-list-wrapper'), function (el) {
  ...
  function getnlp () {
    ...
    if (!getnlp._nlp) {
      if (root && root._getRRuleNLP) {
        ...
        getnlp._nlp = __webpack_require__(134)(RRule)
      } else {
...
Component.options.__file = "/Users/louck/Development/Code/vue-rrulepicker/src/RRulePickerCalendarPanel.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] RRulePickerCalendarPanel.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-764eec1d", Component.options)
  } else {
    hotAPI.reload("data-v-764eec1d", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "rrp-input-icon fa fa-calendar",
    on: {
      "mouseenter": _vm.hoverIcon,
      "mouseleave": _vm.hoverIcon,
      "click": _vm.clickIcon
    ...
    staticClass: "rrp-comingup"
  }, [_c('label', [_vm._v("Eerstvolgende declaraties")]), _vm._v(" "), _c('div', {
    staticClass: "rrp-comingup-dates container"
    ...
    ref: "calendar",
    staticClass: "rrp-popup",
    style: (_vm.position)
  }, [_c('div', {
    staticClass: "rrp-popup-body"
  }, [_c('div', {
    staticClass: "rrp-popup-rrule container"
  }, [_c('div', {
    staticClass: "form-group"
  }, [_c('label', {
    staticClass: "rrp-rrule-label",
    attrs: {
      "for": "rrp_startdate"
    }
    ...
    staticClass: "rrp-rrule-interval-input",
    attrs: {
      "id": "rrp_interval1",
      "type": "number"
    },
    ...
    staticClass: "rrp-rrule-byweekday btn-group-toggle",
    attrs: {
      "data-toggle": "buttons"
    }
  }, _vm._l((_vm.translation.days), function(day, index) {
    return _c('label', {
      staticClass: "btn btn-light rrp-"
    }, [_c('input', {
      attrs: {
        "type": "checkbox"
      },
    ...
    staticClass: "rrp-rrule-bymonthday rrp-rrule-monthly-type-number btn-group-toggle",
    attrs: {
      "data-toggle": "buttons",
    ...
    staticClass: "rrp-rrule-monthly-type-ordinal",
    attrs: {
    ...
    staticClass: "rrp-rrule-bysetpos-input",
    on: {
      "change": function($event) {
        var $$selectedVal = Array.prototype.filter.call($event.target.options, function(o) {
          return o.selected
    ...
    staticClass: "rrp-rrule-byday-input",
    on: {
      "change": function($event) {
        var $$selectedVal = Array.prototype.filter.call($event.target.options, function(o) {
          return o.selected
    ...
    staticClass: "rrp-rrule-yearly-type-ordinal",
    attrs: {
    ...
    staticClass: "rrp-rrule-bymonth-input",
    on: {
      "change": function($event) {
        var $$selectedVal = Array.prototype.filter.call($event.target.options, function(o) {
          return o.selected
    ...
    staticClass: "rrp-rrule-bymonthday-input",
    on: {
      "change": function($event) {
        var $$selectedVal = Array.prototype.filter.call($event.target.options, function(o) {
          return o.selected
  ...
  }))])]) : _vm._e()]), _vm._v(" "), _c('r-rule-picker-calendar-panel', {
    staticClass: "rrp-popup-calendar",
    attrs: {
      "show": _vm.showPopup
    }
  })], 1), _vm._v(" "), (_vm.confirm) ? _c('div', {
    staticClass: "rrp-popup-footer"
  }, [_c('button', {
    staticClass: "btn btn-primary rrp-btn rrp-btn-confirm",
    attrs: {
      "type": "button"
    },
    on: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-1a6b30f9", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-764eec1d", module.exports)
  }
}
...
var update = __webpack_require__(125)("ad6fba44", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-1a6b30f9\",\"scoped\":false,\"hasInlineConfig\":true}!../node_modules/sass-loader/lib/loader.js!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./RRulePicker.vue", function() {
     var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-1a6b30f9\",\"scoped\":false,\"hasInlineConfig\":true}!../node_modules/sass-loader/lib/loader.js!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./RRulePicker.vue");
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(125)("9653def6", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-764eec1d\",\"scoped\":false,\"hasInlineConfig\":true}!../node_modules/sass-loader/lib/loader.js!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./RRulePickerCalendarPanel.vue", function() {
     var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-764eec1d\",\"scoped\":false,\"hasInlineConfig\":true}!../node_modules/sass-loader/lib/loader.js!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./RRulePickerCalendarPanel.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
